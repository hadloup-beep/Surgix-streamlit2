"""
╔══════════════════════════════════════════════════════════════════════╗
║   SURGIX v1.15 Web PurpleEye — Version Streamlit (Cloud)            ║
║   CHU Mohammed VI · Oujda · Service Ophtalmologie                   ║
║   Stockage persistant : Google Drive — compatible PC v1.15 + Android║
╚══════════════════════════════════════════════════════════════════════╝
...
def _encrypt_str(data: str) -> bytes:
    # v1.15 PurpleEye : chiffrement désactivé — JSON pur
    # Compatible Flutter Android + PC v1.15
...
# ═══════════════════════════════════════════════════════════════
st.set_page_config(
    page_title="SURGIX v1.15 Web PurpleEye",
    page_icon="🏥",
    layout="wide",
...
{f["med"]} &nbsp;•&nbsp; SURGIX v1.15 Web PurpleEye</div>
</body></html>"""
